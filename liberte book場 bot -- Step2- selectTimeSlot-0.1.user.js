...
waitForKeyElements ('a[onclick*="08:00-09:00\'\,\'2025-07-04"]', selectTimeSlot);
...
//////// Mouse Over & Click the target time-slot!
    ...
    setTimeout(() => {
        // Select the element
        const element1 = document.querySelector('a[onclick*="08:00-09:00\'\,\'2025-07-04"]');
        console.log(element1);
        const element2 = document.querySelector('a[onclick*="09:00-10:00\'\,\'2025-07-04"]');
